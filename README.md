...
Relion 3.1.3 or newer is required. Old-style STAR files from relion 3.0 or earlier should be converted manually before using this version of AlphaCryo4D.
